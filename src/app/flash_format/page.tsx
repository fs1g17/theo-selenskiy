...
export default function FlashFormat() {
  return (
    <div className="w-full flex flex-col gap-y-10 pb-16">
      <ProjectPageHeader title="Flash Format" />
      ...
      <ProjectSection num="02" heading="What problem does it solve?">
        <p>
          ...
          on the computer, but that&apos;s inconvenient if you just need to
          convert a single file quickly.
        </p>
      </ProjectSection>
      ...
      <ProjectSection num="04" heading="Tech approach">
        <p>
          ...
          with a firebase cloud function, using the &apos;sharp&apos; image
          processing library.
        </p>
      </ProjectSection>
    </div>
